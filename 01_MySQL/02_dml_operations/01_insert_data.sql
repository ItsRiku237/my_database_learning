-- DML (Data Manipulation Language) : ( DML includes: INSERT , UPDATE , DELETE)
...
("riku@gmail.com","Riku",5,"male",'2000-01-01',DEFAULT);

-- Insert by Specifying Column Names (Best Practice, safer and more readable)
INSERT INTO users (name , gender , date_of_birth , email) VALUES
('Jubbu','female','2000-07-19','jubbuu@gmail.com'),
('omsoumya','male','2000-08-07','omsoumya@gmail.com');
